...
namespace Bookstore.Data
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        {
            // -------------------------
            // Existing relationships & constraints (preserved exactly)
            // -------------------------
            ...
            // -------------------------
            // Boolean conversions (EF Core / PostgreSQL)
            // -------------------------
            ...
            // -------------------------
            // Fluent API schema mappings — table & column names (schema: bobsbookstore_dbo)
            // -------------------------
