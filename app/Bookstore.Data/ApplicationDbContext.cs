...
namespace Bookstore.Data
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // ---------------------------------------------------------------
            // Book  (preserves existing FK / relationship configuration)
            // ---------------------------------------------------------------
            ...
            // ---------------------------------------------------------------
            // Offer  (preserves existing FK / relationship configuration)
            // ---------------------------------------------------------------
            ...
            // ---------------------------------------------------------------
            // Order  (preserves existing FK / relationship configuration)
            // ---------------------------------------------------------------
            ...
            // ---------------------------------------------------------------
            // ReferenceData  (DbSet name is ReferenceData; entity class is ReferenceDataItem)
            // ---------------------------------------------------------------
