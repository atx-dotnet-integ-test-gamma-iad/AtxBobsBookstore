...
namespace Bookstore.Data
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // -------------------------------------------------------------------------
            // Book  (preserves existing FK / delete-behavior constraints)
            // -------------------------------------------------------------------------
            ...
            // -------------------------------------------------------------------------
            // Customer  (preserves existing unique index on Sub)
            // -------------------------------------------------------------------------
            ...
            // -------------------------------------------------------------------------
            // Order  (preserves existing Customer FK / delete-behavior constraint)
            // Note: TargetTableName retains original Pascal casing "Order" as per schema mapping
            // -------------------------------------------------------------------------
            ...
            // -------------------------------------------------------------------------
            // Offer  (preserves existing FK / delete-behavior constraints)
            // -------------------------------------------------------------------------
            ...
            // -------------------------------------------------------------------------
            // ReferenceData  (DbSet<ReferenceDataItem> ReferenceData)
            // -------------------------------------------------------------------------
