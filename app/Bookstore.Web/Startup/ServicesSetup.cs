    ...
    public static class ServicesSetup
    {
        ...
        private static string GetDatabaseConnectionString(ConfigurationManager configuration)
        {
            ...
            try
            {
                ...
                // (Amazon RDS PostgreSQL). For this code to work locally, appsettings.json must contain an AWS
                // object with profile and region info. When deployed to an EC2 instance, credentials and region
                // will be inferred from the instance profile applied to the instance.
