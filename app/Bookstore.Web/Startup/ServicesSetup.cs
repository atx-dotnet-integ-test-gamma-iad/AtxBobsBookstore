...
namespace Bookstore.Web.Startup
{
    public static class ServicesSetup
    {
        ...
        private static string GetDatabaseConnectionString(ConfigurationManager configuration)
        {
            ...
            const string TargetSecretArn = "arn:aws:secretsmanager:us-east-1:812756961751:secret:atx-db-modernization-sc-sql-server-secret-gadgetsonline-target-47zzs2";
            ...
            try
            {
                // Use target PostgreSQL secret ARN
