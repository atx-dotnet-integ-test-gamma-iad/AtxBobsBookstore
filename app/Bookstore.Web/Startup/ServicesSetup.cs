...
namespace Bookstore.Web.Startup
{
    public static class ServicesSetup
    {
        ...
        private static string GetDatabaseConnectionString(ConfigurationManager configuration)
        {
            ...
            try
            {
                var dbSecretId = "arn:aws:secretsmanager:us-east-1:812756961751:secret:atx-db-modernization-test-DBConnector-setup-bobsBookStoreDB-source-target-FU71Bm";
                Console.WriteLine($"Reading db credentials from target secret {dbSecretId}");
