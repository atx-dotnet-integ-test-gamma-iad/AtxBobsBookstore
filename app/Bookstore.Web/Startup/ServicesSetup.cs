...
namespace Bookstore.Web.Startup
{
    public static class ServicesSetup
    {
        ...
        {
            // This is the key of a string value in Parameter Store containing the ARN of the
            // secret in Secrets Manager that contains the credentials of the PostgreSQL database.
            // The reason for the indirection is that a secret name is suffixed automatically
