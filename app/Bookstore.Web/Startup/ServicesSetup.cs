...
namespace Bookstore.Web.Startup
{
    public static class ServicesSetup
    {
        ...
        private static string GetDatabaseConnectionString(ConfigurationManager configuration)
        {
            ...
            const string TargetSecretArn = "arn:aws:secretsmanager:us-east-1:812756961751:secret:atx-db-modernization-test-DBConnector-setup-bobsBookStoreDB-source-target-FU71Bm";
            ...
            try
            {
                // Use target secret ARN for PostgreSQL database
