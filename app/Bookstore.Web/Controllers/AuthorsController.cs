...
namespace Bookstore.Web.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public async Task<bool> EditUsingStoredProcedure(int businessEntityId, string nationalIdNumber, DateTime birthDate, string maritalStatus, string gender)
        {
            try
            {
                // Converted from SQL Server stored procedure call to PostgreSQL inline UPDATE
...
WHERE BusinessEntityID = @BusinessEntityID;";
        ...
        public async Task<bool> DeleteAuthorEmbeddedSql(int businessEntityId)
        {
            try
            {
                // Converted from SQL Server stored procedure call to PostgreSQL inline DELETE
        ...
        public async Task<List<AuthorAgeResult>> SelectAuthorsByHireYear(int hireYear)
        {
            try
            {
                // Converted from SQL Server date/time functions to PostgreSQL equivalents
                ...
                // Conversions: FORMAT→TO_CHAR, DATEDIFF→DATE_PART/AGE, DATEPART→EXTRACT, GETDATE→CURRENT_DATE
