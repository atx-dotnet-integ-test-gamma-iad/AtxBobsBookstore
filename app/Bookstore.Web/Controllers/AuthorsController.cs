    ...
    public class AuthorsController : Controller
    {
        ...
        public async Task<List<Author>> FindAllAuthorsEmbeddedSql()
        {
            try
            {
                ...
                // WARNING: AWS DMS statement conversion failed after 3 attempts (Unknown failure reason).
                // SQL converted using standard T-SQL to PostgreSQL rules. Please verify correctness.
