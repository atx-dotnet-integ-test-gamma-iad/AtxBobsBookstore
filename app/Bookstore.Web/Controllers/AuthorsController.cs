    ...
    public class AuthorsController : Controller
    {
        ...
        public async Task<List<Author>> FindAllAuthorsEmbeddedSql()
        {
            try
            {
                ...
                // TODO: SQL conversion failed (DMS service error) - manual conversion required: qualify table 'Author' with target schema prefix and verify PostgreSQL compatibility.
        ...
        public async Task<List<AuthorAgeResult>> SelectAuthorsByHireYear(int hireYear)
        {
            ...
            {
                // Build the SQL command
                // TODO: SQL conversion failed (DMS service error) - manual conversion required: convert FORMAT→TO_CHAR, DATEDIFF→EXTRACT(YEAR FROM AGE(...)), GETDATE()→CURRENT_DATE, DATEPART→EXTRACT, qualify table 'Author' with target schema prefix.
