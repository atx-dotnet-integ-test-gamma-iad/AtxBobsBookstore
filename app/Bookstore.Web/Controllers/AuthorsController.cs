...
namespace Bookstore.Web.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public async Task<bool> EditUsingStoredProcedure(int businessEntityId, string nationalIdNumber, DateTime birthDate, string maritalStatus, string gender)
        {
            try
            {
                // TODO: Migrate SQL Server stored procedure [dbo].[uspUpdateAuthorPersonalInfo] to PostgreSQL function in schema bobsbookstore_dbo
                string sql = @"EXEC [dbo].[uspUpdateAuthorPersonalInfo] @BusinessEntityID, @NationalIDNumber, @BirthDate, @MaritalStatus, @Gender;";
        ...
        public async Task<bool> DeleteAuthorEmbeddedSql(int businessEntityId)
        {
            ...
            {
                // Build the SQL command
                // TODO: Migrate SQL Server stored procedure [dbo].[uspDeleteAuthor] to PostgreSQL function in schema bobsbookstore_dbo
                string sql = @"EXEC [dbo].[uspDeleteAuthor] @BusinessEntityID;";
