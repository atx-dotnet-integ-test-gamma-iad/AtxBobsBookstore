...
namespace Bookstore.Web.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public async Task<bool> EditUsingStoredProcedure(int businessEntityId, string nationalIdNumber, DateTime birthDate, string maritalStatus, string gender)
        {
            try
            {
                // NOTE: This stored procedure call requires a PostgreSQL function [dbo].[uspUpdateAuthorPersonalInfo] to be created in the target database
                // or needs to be replaced with equivalent EF Core queries
        ...
        public async Task<bool> DeleteAuthorEmbeddedSql(int businessEntityId)
        {
            try
            {
                // NOTE: This stored procedure call requires a PostgreSQL function [dbo].[uspDeleteAuthor] to be created in the target database
                // or needs to be replaced with equivalent EF Core queries
                // Build the SQL command
