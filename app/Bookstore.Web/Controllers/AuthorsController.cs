    ...
    public class AuthorsController : Controller
    {
        ...
        public async Task<List<Author>> FindAllAuthorsEmbeddedSql()
        {
            try
            {
                ...
                // WARNING: SQL conversion failed after 3 attempts (DMS metadata model creation error).
                // Manual review required: qualify table name as bobsbookstore_dbo.author
        ...
        public async Task<List<AuthorAgeResult>> SelectAuthorsByHireYear(int hireYear)
        {
            ...
            {
                // Build the SQL command
                // WARNING: DMS conversion failed after 3 attempts (metadata model creation error).
                // T-SQL functions manually converted: FORMAT->TO_CHAR, DATEDIFF->EXTRACT/AGE, GETDATE->CURRENT_DATE, DATEPART->EXTRACT
                // Table qualified as: bobsbookstore_dbo.author
