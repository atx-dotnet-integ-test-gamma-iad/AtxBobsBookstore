    ...
    public class AuthorsController : Controller
    {
        ...
        public async Task<List<Author>> FindAllAuthorsEmbeddedSql()
        {
            try
            {
                ...
                // NOTE: SQL converted from SQL Server to PostgreSQL.
                // AWS DMS convert_sql_statement was unavailable (service error after 3 retries);
                // conversion applied using known project schema mapping (bobsbookstore_dbo) and
                // standard T-SQL -> PostgreSQL rules.
        ...
        public async Task<List<AuthorAgeResult>> SelectAuthorsByHireYear(int hireYear)
        {
            try
            {
                ...
                //   FROM Author -> FROM bobsbookstore_dbo.author
