    ...
    public class AuthorsController : Controller
    {
        ...
        public async Task<bool> EditUsingStoredProcedure(int businessEntityId, string nationalIdNumber, DateTime birthDate, string maritalStatus, string gender)
        {
            try
            {
                ...
                // PostgreSQL does not support EXEC; use CALL BobsBookstore_dbo.uspUpdateAuthorPersonalInfo(...) or SELECT BobsBookstore_dbo.uspUpdateAuthorPersonalInfo(...) depending on whether it is a procedure or function.
        ...
        public async Task<bool> DeleteAuthorEmbeddedSql(int businessEntityId)
        {
            try
            {
                ...
                // TODO: Manual migration required - Stored procedure call detected.
                // This stored procedure needs to be migrated to PostgreSQL and this call updated accordingly.
                // PostgreSQL does not support EXEC; use CALL BobsBookstore_dbo.uspDeleteAuthor(...) or SELECT BobsBookstore_dbo.uspDeleteAuthor(...) depending on whether it is a procedure or function.
