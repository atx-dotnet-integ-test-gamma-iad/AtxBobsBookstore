...
namespace Bookstore.Web.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public async Task<bool> EditUsingStoredProcedure(int businessEntityId, string nationalIdNumber, DateTime birthDate, string maritalStatus, string gender)
        {
            try
            {
                // TODO: This stored procedure must be recreated in PostgreSQL. Replace [dbo].[uspUpdateAuthorPersonalInfo] with the equivalent PostgreSQL function call using CALL or SELECT syntax.
        ...
        public async Task<bool> DeleteAuthorEmbeddedSql(int businessEntityId)
        {
            try
            {
                // TODO: This stored procedure must be recreated in PostgreSQL. Replace [dbo].[uspDeleteAuthor] with the equivalent PostgreSQL function call using CALL or SELECT syntax.
                // Build the SQL command
