...
namespace Bookstore.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<List<Product>> FindAllProducts()
        {
            try
            {
                // TODO: This stored procedure must be recreated in PostgreSQL. Replace [dbo].[uspGetProductData] with the equivalent PostgreSQL function call using CALL or SELECT syntax.
