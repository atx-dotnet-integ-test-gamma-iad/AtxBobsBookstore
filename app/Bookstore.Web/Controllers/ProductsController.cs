...
namespace Bookstore.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<List<Product>> FindAllProducts()
        {
            try
            {
                // PostgreSQL: Converted from T-SQL stored procedure EXEC to table-valued function call
                // Original: EXEC [dbo].[uspGetProductData];
                // Schema change: [dbo].[uspGetProductData] → bobsbookstore_dbo.uspgetproductdata
